...
export type JoinTranslatorArg =
  | TranslateKey
  | readonly [TranslateKey, TranslateOptions];

export type JoinTranslator = (...args: JoinTranslatorArg[]) => string;
export type NamespaceInput<Namespace extends string> =
  | Namespace
  | readonly Namespace[];
...
export type DefaultNamespaces<
  Config extends I18nConfig<any, any, any, any, any>
...
> = Prettify<
  Awaited<ReturnType<Resource[keyof Resource][ToNSArr<Namespaces>[number]]>>
>;
...
type GetNamespaceResource<
  Namespace extends string,
  Resource extends ResourceLoaders<string, string>,
> = Awaited<
  ReturnType<
    Resource[keyof Resource][Namespace & keyof Resource[keyof Resource]]
  >
>;

type LiteralUnion<T extends string> = T | (string & {});

type AllNamespaceKeys<
  Namespaces extends NamespaceInput<string>,
  Resource extends ResourceLoaders<string, string>,
> = {
...
export type TranslateKeyWithNamespace<
  ...
  Resource extends ResourceLoaders<string, string>,
> = LiteralUnion<
  | TranslationKeys<Prettify<LoadedResource<Namespaces, Resource>>>
  | AllNamespaceKeys<Namespaces, Resource>
>;
